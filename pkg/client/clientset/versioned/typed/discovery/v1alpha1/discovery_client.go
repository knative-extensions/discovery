...
import (
	...
	"knative.dev/discovery/pkg/client/clientset/versioned/scheme"
)
...
// NewForConfigAndClient creates a new DiscoveryV1alpha1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*DiscoveryV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
