...
import (
	...
	ducktype "knative.dev/discovery/pkg/client/injection/reconciler/discovery/v1alpha1/ducktype"
...
func newReconciledNormal(namespace, name string) reconciler.Event {
	return reconciler.NewEvent(v1.EventTypeNormal, "DuckTypeReconciled", "DuckType reconciled: \"%s/%s\"", namespace, name)
}
...
var _ ducktype.Interface = (*Reconciler)(nil)

// Optionally check that our Reconciler implements Finalizer
//var _ ducktype.Finalizer = (*Reconciler)(nil)
...
//var _ ducktype.ReadOnlyInterface = (*Reconciler)(nil)
...
//var _ ducktype.ReadOnlyFinalizer = (*Reconciler)(nil)

// ReconcileKind implements Interface.ReconcileKind.
func (r *Reconciler) ReconcileKind(ctx context.Context, o *v1alpha1.DuckType) reconciler.Event {
...
//func (r *Reconciler) FinalizeKind(ctx context.Context, o *v1alpha1.DuckType) reconciler.Event {
//	// TODO: add custom finalization logic here.
//	return nil
//}

// Optionally, use ObserveKind to observe the resource when we are not the leader.
// func (r *Reconciler) ObserveKind(ctx context.Context, o *v1alpha1.DuckType) reconciler.Event {
...
//func (r *Reconciler) ObserveFinalizeKind(ctx context.Context, o *v1alpha1.DuckType) reconciler.Event {
// 	// TODO: add custom observation logic here.
//	return nil
//}
