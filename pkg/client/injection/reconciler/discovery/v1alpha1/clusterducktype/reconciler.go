...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1alpha1.ClusterDuckType, desiredFinalizers sets.String) (*v1alpha1.ClusterDuckType, error) {
	// Don't modify the informers copy.
