...
import (
	...
	versionedscheme "knative.dev/discovery/pkg/client/clientset/versioned/scheme"
...
const (
	defaultControllerAgentName = "clusterducktype-controller"
	defaultFinalizerName       = "clusterducktypes.discovery.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	clusterducktypeInformer := clusterducktype.Get(ctx)

	lister := clusterducktypeInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "discovery.knative.dev.ClusterDuckType"),
	)
